...
Stdcreate.o : Stdtcreate.c Stdtcreate.h
...
structures.o : structures.c structures.h
	gcc -o structures.c structures.o

exec : Robust.o DisplayTXT.o Game.o Save.o Stdtcreate.o main.o statPlayer.o structures.o
	gcc Robust.o DisplayTXT.o Game.o Save.o Stdtcreate.o main.o statPlayer.o structures.o -o exec
